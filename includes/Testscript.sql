...
CREATE TABLE Rubriek(
	Rubrieknummer				NUMERIC(10)		NOT NULL,
	Rubrieknaam					VARCHAR(32)		NOT NULL,
	Rubriek						NUMERIC(10)			NULL,
	Volgnr						INTEGER			NOT NULL
...
CREATE TABLE VoorwerpInRubriek(
	Voorwerp						NUMERIC(10)			NOT NULL,
	RubriekOpLaagsteNiveau			NUMERIC(10)			NOT NULL,
...
CREATE TABLE Voorwerp(
	Voorwerpnummer				NUMERIC(10)		IDENTITY,
...
ADD CONSTRAINT FK_VoorwerpInRubriek_voorwerpnummer FOREIGN KEY (Voorwerp)
		...
		ON UPDATE NO ACTION
		ON DELETE NO ACTION,
	CONSTRAINT FK_VoorwerpInRubriek_rubrieknummer FOREIGN KEY (RubriekOpLaagsteNiveau)
		REFERENCES Rubriek (rubrieknummer)
		ON UPDATE NO ACTION
		ON DELETE NO ACTION
