        ...
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php if (file_exists("upload/users/" . $profile_data['Gebruikersnaam'] . ".png")): ?>
                            <img src="upload/users/<?= $profile_data['Gebruikersnaam'] ?>.png" class="card-img"
                                 alt="profielfoto">
                        <?php else : ?>
                    ...
                    <div class="card-body">
                        ...
                        elseif($_SESSION['name']!=$_GET['id']&&!Seller::commentedOnUser($_SESSION['name'], $_GET['id'])):
                            ...
                            <div class="text-right">
                                ...
                                <div class="dropdown-menu dropdown-menu-right animate slideIn">
                                    <p>Je kan pas feedback en een rating geven als je een bod hebt gewonnen van deze verkoper.</p>
                                </div>
                            </div>
                        <?php endif;
            ...
            <div class="col-xl-4 col-md-6 col-sm-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">
                            Rating: <?= round(Database::getAvgRating($profile_data['Gebruikersnaam'])[""], 2) ?></h4>
                        <?php
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-6">
                        <div class="card">
                            <a href='item.php?id=<?= $item['Voorwerpnummer'] ?>'>
                                <img src='upload/items/<?= $item['Voorwerpnummer'] ?>.png' class='card-img-top'
