        ...
        <div class="container">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="" id="bank" placeholder="Uw bank">
                </div>
                <!-- BANKREKENING -->
                <div class="form-group col-md-6">
                    <label for="bankrekening">Bankrekening</label>
                    <input type="text" class="form-control" name="" id="bankrekening" placeholder="Uw bankrekening">
                </div>
                <!-- CONTROLEOPTIE -->
                <div class="form-group col-md-6">
                    <label for="controlenummer">ControleOptie</label>
                    <input type="text" class="form-control" name="" id="controlenummer" placeholder="Uw controlenummer">
                </div>
                <!-- CREDITCARD -->
                <div class="form-group col-md-6">
                    <label for="creditcard">Creditcard</label>
                    <input type="text" class="form-control" name="" id="creditcard" placeholder="Uw creditcard">
                </div>
